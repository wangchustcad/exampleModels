...
model System_Failure_1A "失效形式1A: 预紧弹簧太紧"
...
protected
  ...
  Components.SlidingMass slidingMass(phi=0.005235987755983)
    annotation (Placement(transformation(extent = {{-170, -20}, {-130, 20}})));
  SandTable.Components.ElastoGapRear elastoGapRear(c=1e5, d=1e4)
    annotation (Placement(transformation(extent = {{-200, -10}, {-180, 10}})));
  Components.ElastoGapFore elastoGapFore(d = 1e4)
